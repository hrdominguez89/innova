                        ...
                        <div class="row">
                          <div class="col-6">
                            <div class="form-group">
                              ...
                              <input type="date" min="<?php echo date('Y-m-d', time()); ?>" class="form-control" name="inicio_del_desafio" id="editar_inicio_del_desafio">
                            </div>
                          </div>
                          <div class="col-6">
                            <div class="form-group">
                              <label for="editar_fin_del_desafio">Fin del desafío</label>
                              <input type="date" min="<?php echo date('Y-m-d', time()); ?>" class="form-control" name="fin_del_desafio" id="editar_fin_del_desafio">
                            </div>
                          </div>
