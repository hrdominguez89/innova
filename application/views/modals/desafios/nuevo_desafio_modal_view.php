<!-- Modal -->
<div class="modal fade" id="nuevoDesafioModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="tituloNuevoDesafioModal" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h3 id="tituloNuevoDesafioModal">Nuevo desafío</h3>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <div class="modal-body">
                      <form id="formularioNuevoDesafio">
                        <div class="row">
                          <div class="col-6">
                          ...
                          <div class="col-12 mt-2 text-left" id="erroresModalNuevoDesafio">
                          </div>
                        </div>
                      </form>
                      <div class="row" id="loadingNuevoModal" style="display: none;">
                    ...
                    <div class="modal-footer" id="botoneFooterNuevoDesafioModal">
