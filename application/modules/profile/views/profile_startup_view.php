                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo base_url() . 'profile'; ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-floating" for="email_startup">E-mail de la empresa <i class="fas fa-envelope"></i><small> (opcional)</small></label>
                                        <input type="email" class="form-control" id="email_startup" name="email_startup" value="<?php echo set_value('email_startup', $data_perfil->email_startup); ?>">
                                        <?php echo form_error('email_startup'); ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-floating" for="telefono_startup">Teléfono de la empresa <i class="fas fa-phone"></i><small> (opcional)</small></label>
                                        <input type="text" class="form-control" name="telefono_startup" id="telefono_startup" value="<?php echo set_value('telefono_startup', $data_perfil->telefono_startup); ?>">
                                        <?php echo form_error('telefono_startup'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group bmd-form-group">
                                        <label class="bmd-label-floating">Antecedentes </label>
                                        <textarea name="antecedentes" id="antecedentes" class="form-control" rows="3"><?php echo set_value('antecedentes', $data_perfil->antecedentes); ?></textarea>
                            ...
                            <div class="row mb-4">
                                <label class="col-sm-3 col-form-label label-checkbox text-left pl-3">Servicios /<br>Productos que ofrece <small class="text-danger"> *</small></label>
                                    ...
                                    <?php foreach ($categorias as $categoria) :; ?>
                                        ...
                                        if ($categorias_seleccionadas) {
                                            foreach ($categorias_seleccionadas as $categoria_seleccionada) {
                                                if ($categoria_seleccionada->categoria_id == $categoria->id) {
                                                    $checked = true;
                                                    $texto_descripcion = $categoria_seleccionada->descripcion_categoria_seleccionada;
                                                }
                                            }
                                        } ?>
                                        <div class="col-12 form-check form-check-inline">
                                            <label class="form-check-label" for="category-<?php echo $categoria->id; ?>">
                                                <input class="form-check-input categoriesCheckbox" type="checkbox" name="categories[]" <?php echo set_checkbox('categories[]', $categoria->id, $checked); ?> id="category-<?php echo $categoria->id; ?>" value="<?php echo $categoria->id; ?>">
                                        ...
                                        <div class="col-md-12 <?php echo $checked || set_checkbox('categories[]', $categoria->id) ? 'd-block mt-3' : 'd-none'; ?>" id="div_category_description_<?php echo $categoria->id; ?>">
                                            <div class="form-group bmd-form-group">
                                                <label class="bmd-label-floating" for="category_description_<?php echo $categoria->id; ?>"><?php echo $categoria->descripcion; ?> descripción: </label>
                                                <textarea name="category_description[<?php echo $categoria->id; ?>]" id="category_description_<?php echo $categoria->id; ?>" class="form-control" rows="3"><?php echo set_value('category_description[' . $categoria->id . ']', $texto_descripcion); ?></textarea>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
